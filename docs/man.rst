...
-----------------------
The basic installation will install the quipucords server and the qpc cli at the same time. However, you may choose to install the cli and server on seperate machines.
